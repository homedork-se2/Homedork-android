...
import static com.example.homedork.PassNotif.CHANNEL_2_ID;
                        ...
                        if (task.isSuccessful()) {
                            user.updatePassword(newpass).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                 ...
                                 /*       Notification notification = new NotificationCompat.Builder(ResetPasswordActivity.this, CHANNEL_2_ID)
                                                .setSmallIcon(R.mipmap.ic_launcher)// change (ic_Launcher) to make app icon for notification
